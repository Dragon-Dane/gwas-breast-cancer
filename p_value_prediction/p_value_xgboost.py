...
if __name__ == "__main__":
    ...
    if dataset=='NIH':
        ...
        df = pd.read_csv("../data/final_michailidu_genenames_disease_association.csv")
    ...
    p_values = df['P-value']
    if dataset=='NIH': # NIH's p-values are -log values
    ...
    for train_index, val_index in skf.split(X, y):
        ...
        xgb_clf = xgb.XGBClassifier(n_estimators=3000, booster='gbtree', verbosity=1, n_jobs=1, scale_pos_weight=scale_pos_weight, random_state=123)
